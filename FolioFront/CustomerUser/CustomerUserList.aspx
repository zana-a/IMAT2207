...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    <div class="container-lg">
        ...
        <form id="formCustomerUserList" runat="server">
            <div>
                <asp:ListBox CssClass="form-select width-fit height-full width-full" ID="lstCustomerUserList" runat="server"></asp:ListBox>
            </div>
            <div class="d-flex py-4 width-full flex-justify-end">
                <asp:button CssClass="btn mr-2 btn-primary" runat="server" text="Add" ID="Button1" OnClick="btnAdd_Click"/>
